...
export function isI64(type: string): boolean {
    ...
    return type === "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i64::I64";
}
...
export class I64 implements StructClass {
    static readonly $typeName = "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i64::I64";
    static readonly $numTypeParams = 0;

    readonly $typeName = I64.$typeName;

    readonly $fullTypeName: "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i64::I64";
    ...
    private constructor(typeArgs: [], fields: I64Fields,
        ...
        this.$fullTypeName = composeSuiType(
            I64.$typeName,
            ...typeArgs
        ) as "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i64::I64";
