...
export function isLinkedTable(type: string): boolean {
    ...
    return type.startsWith("0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable<");
}

export interface LinkedTableFields<K extends TypeArgument, V extends PhantomTypeArgument> {
    id: ToField<UID>; head: ToField<Option<K>>; tail: ToField<Option<K>>; size: ToField<"u64">
}
...
export class LinkedTable<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass {
    static readonly $typeName = "0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable";
    static readonly $numTypeParams = 2;

    readonly $typeName = LinkedTable.$typeName;

    readonly $fullTypeName: `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>], fields: LinkedTableFields<K, V>,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
        this.$typeArgs = typeArgs;

        this.id = fields.id;; this.head = fields.head;; this.tail = fields.tail;; this.size = fields.size;
    }
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            ) as `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable<${ToTypeStr<ToTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`,
            typeArgs: [
                extractType(K), extractType(V)
    ...
    static fromFields<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LinkedTable.reified(
            ...
            {id: decodeFromFields(UID.reified(), fields.id), head: decodeFromFields(Option.reified(typeArgs[0]), fields.head), tail: decodeFromFields(Option.reified(typeArgs[0]), fields.tail), size: decodeFromFields("u64", fields.size)}
        )
    }
    ...
    static fromFieldsWithTypes<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LinkedTable.reified(
            ...
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), head: decodeFromFieldsWithTypes(Option.reified(typeArgs[0]), item.fields.head), tail: decodeFromFieldsWithTypes(Option.reified(typeArgs[0]), item.fields.tail), size: decodeFromFieldsWithTypes("u64", item.fields.size)}
        )
    }
    ...
    toJSONField() {
        return {
            id: this.id,head: fieldToJSON<Option<K>>(`0x1::option::Option<${this.$typeArgs[0]}>`, this.head),tail: fieldToJSON<Option<K>>(`0x1::option::Option<${this.$typeArgs[0]}>`, this.tail),size: this.size.toString(),
    ...
    static fromJSONField<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LinkedTable.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), head: decodeFromJSONField(Option.reified(typeArgs[0]), field.head), tail: decodeFromJSONField(Option.reified(typeArgs[0]), field.tail), size: decodeFromJSONField("u64", field.size)}
        )
    }
...
export function isNode(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::Node<");
}
...
export class Node<K extends TypeArgument, V extends TypeArgument> implements StructClass {
    static readonly $typeName = "0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::Node";
    static readonly $numTypeParams = 2;

    readonly $typeName = Node.$typeName;

    readonly $fullTypeName: `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::Node<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: NodeFields<K, V>,
        ...
        this.$fullTypeName = composeSuiType(
            Node.$typeName,
            ...typeArgs
        ) as `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::Node<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            fullTypeName: composeSuiType(
                Node.$typeName,
                ...[extractType(K), extractType(V)]
            ) as `0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::Node<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`,
            typeArgs: [
                extractType(K), extractType(V)
