...
export function isI128(type: string): boolean {
    ...
    return type === "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128";
}
...
export class I128 implements StructClass {
    static readonly $typeName = "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128";
    static readonly $numTypeParams = 0;

    readonly $typeName = I128.$typeName;

    readonly $fullTypeName: "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128";
    ...
    private constructor(typeArgs: [], fields: I128Fields,
        ...
        this.$fullTypeName = composeSuiType(
            I128.$typeName,
            ...typeArgs
        ) as "0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128";
